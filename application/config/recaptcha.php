...
$config['recaptcha_sitekey'] = "6LetyBMUAAAAANXh7w7cm1qwV5uyA3oRJOW_rWa-";
$config['recaptcha_secretkey'] = "6LetyBMUAAAAAEytlDkE4S6mYW8fdeHOn2UcZyNj";
$config['lang'] = "id";

// captcha pakai captcha google, signup dlu jangan lupa