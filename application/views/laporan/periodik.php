					...
					<div class="box-body">
						...
						<div class="form-group">
							<div class="box-body">
								...
								<div class="row">
									<div class="col-xs-4">
			                  			<input type="text" name="" id="tglnota" class="form-control" placeholder="Tanggal">
			                		</div>
			                		<div class="col-xs-4">
			                  			<input type="text" nama="" id="notakeluar" class="form-control" placeholder="Tanggal">
			                		</div>
	                			</div>
							</div>
						</div>
